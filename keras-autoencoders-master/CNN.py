...
model.add(Conv2D(32, kernel_size=(2, 2), kernel_constraint=max_norm(max_norm_value), activation='relu', kernel_initializer='he_uniform'))
model.add(MaxPooling2D((2, 2), padding='same'))
...
# model.add(Conv2D(128, kernel_size=(3,3), kernel_constraint=max_norm(max_norm_value), activation='relu', kernel_initializer='he_uniform'))
# model.add(UpSampling2D((2, 2), padding='same'))
# model.add(Conv2D(1, kernel_size=(3, 3), kernel_constraint=max_norm(max_norm_value), activation='sigmoid', padding='same'))
...
model.save('10_25SNR_14EPOCH_2048N_CNN')
